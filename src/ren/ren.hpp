...
template <typename Private> struct ren_api {
  ...
  FORCE_INLINE void draw(camera_handle p_camera, program_handle p_shader,
                         ...
                         mesh_handle p_mesh) {
    thiz.draw(p_camera, p_shader, p_material, p_transform, p_mesh);
  };
